...
def computeReturnRate(priceVec, fast_period, slow_period, signal_period):
    ...
    for ic in range(dataCount):
        ...
        suggestedAction[ic] = myStrategy(
            priceVec[0:ic], currentPrice, fast_period, slow_period, signal_period
        )

        # get real action by suggested action
        if ic > 0:
            stockHolding[ic] = stockHolding[
                ic - 1
...
if __name__ == "__main__":
        ...
        for slow_period in slow_periods:
            ...
            for signal_period in signal_periods:
                ...
                returnRate = computeReturnRate(
                    adjClose, fast_period, slow_period, signal_period
                )
    ...
    print(
        "Best settings: fast_period=%d, slow_period=%d, signal_period=%d ==> returnRate=%f"
